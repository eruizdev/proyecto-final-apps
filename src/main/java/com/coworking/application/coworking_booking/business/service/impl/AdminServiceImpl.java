...
public class AdminServiceImpl
  ...
  @Override public List<AuditLogEntity> auditsAll(){ return repo.listAll(); }
  @Override public List<AuditLogEntity> auditsByUser(Long userId){ return repo.listByUser(userId); }
  @Override public List<AuditLogEntity> auditsByEntityType(String entityType, int limit){
